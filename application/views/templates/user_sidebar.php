<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="transition: all 0.9s;" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user') ?>">
		...
		<div class="sidebar-brand-text mx-3" style="transition: all 0.9s;">Absensi IT Company</div>
	</a>
	...
	<li class="nav-item mt-2">
		<a style="transition: all 0.9s;" class="nav-link" href="<?= base_url('user/profile') ?>">
